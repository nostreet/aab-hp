...
def create_topic(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for peep in user:
                if request.user.email != peep.email:
                    email_list = email_list  + peep.email + ","
            subject = "AAB - new forum topic has been created"
            message = (
                """Hey, <br>
                There is a new forum topic on our members homepage, come and check it out:<br>
                <a href="https://www.aabees.co.nz/forum/">Link to Forum</a> <br><br>

                Topic: """ + topic +
                "<br><br> Sincerely, <br>All About Bees team"
                )
            from_email = 'aabeesnc@gmail.com'
            print(email_list)
            msg = EmailMessage(subject, message, from_email, [email_list],)
